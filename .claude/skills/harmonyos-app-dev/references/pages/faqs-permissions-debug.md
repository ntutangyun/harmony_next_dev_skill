...
以tcpdump工具为例，使用二进制签名工具签名时在module.json文件中配置ohos.permission.kernel.NET_RAW权限。
...
以lldb高性能调试器为例，使用二进制签名工具签名时在module.json文件中配置ohos.permission.kernel.DEBUGGER权限。
