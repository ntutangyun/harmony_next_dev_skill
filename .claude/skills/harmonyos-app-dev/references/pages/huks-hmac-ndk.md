...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-hmac-ndk_

HMAC是密钥相关的哈希运算消息认证码（Hash-based Message Authentication Code）。具体的场景介绍及支持的算法规格，请参考HMAC介绍及算法规格。
...
调用OH_Huks_GenerateKeyItem生成密钥，HMAC支持的规格请参考密钥生成支持的算法。
...
调用OH_Huks_FinishSession结束密钥会话，获取哈希后的数据。
