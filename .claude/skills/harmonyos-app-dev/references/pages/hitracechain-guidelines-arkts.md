...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hitracechain-guidelines-arkts_
...
hiTraceChain.isValid(id: HiTraceId): boolean	
...
hiTraceChain.isFlagEnabled(id: HiTraceId, flag: HiTraceFlag): boolean	
...
async/await和promise/then异步任务支持HiTraceChain自动传递，示例结合事件订阅（ArkTS）和使用HiTraceMeter跟踪性能（ArkTS），说明分布式跟踪在ArkTS中的使用方法。
