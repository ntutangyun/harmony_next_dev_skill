...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-environment_
...
字体大小比例。开发者需要配置configuration，设置fontSizeScale为"followSystem"，具体配置步骤可参考configuration使fontScale跟随系统变化。
...
字体粗细程度。在不同的系统或者机型中，fontWeightScale的取值范围可能会有所不同。
