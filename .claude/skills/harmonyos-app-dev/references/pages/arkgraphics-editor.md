...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkgraphics-editor_
...
前往下载中心下载最新版本ArkGraphics Editor插件。
...
前往下载中心下载最新版本ArkGraphics Editor编辑器，并进行安装。
