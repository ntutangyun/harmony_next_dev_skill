...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-appstoragev2_
...
以上接口详细描述请参考状态管理API文档中的AppStorageV2。

使用限制

1、只支持class类型，否则会抛出运行时报错，从API version 23开始，将返回错误码140103。
