...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/vibrator-guidelines-capi_
...
控制设备上的振动器，需要申请权限ohos.permission.VIBRATE。具体配置方式请参考声明权限。
