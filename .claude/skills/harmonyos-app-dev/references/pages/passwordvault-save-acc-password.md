...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/passwordvault-save-acc-password_
...
密码保险箱的自动保存功能只适用于用户名和密码保存场景，在界面中必须同时存在用户名和密码的TextInput输入框组件。具体类型请参考输入框类型说明。
