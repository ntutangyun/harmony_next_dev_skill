...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/fault-detection-overview_
...
Native代码未处理崩溃异常信号时会生成CppCrash日志，详见Cpp Crash（进程崩溃）检测。

JS/ArkTS代码未处理异常时会生成JsCrash日志，详见JS Crash（进程崩溃）检测。
