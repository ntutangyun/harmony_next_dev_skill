...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-universal-attributes-accessibility_
...
优化全用户群体体验：适配过程中的核心优化（如清晰的文本描述和操作提醒、合理地设计焦点热区大小），让视障用户获得更流畅的使用体验。
...
- 对隐藏/非交互内容，通过accessibilityLevel('no')禁止其被聚焦选中。

- 针对无实际节点的交互区域，通过accessibilityVirtualNode配置虚拟节点作为焦点占位符。


保证有1个焦点	确保页面可见区域内始终有且仅有1个焦点，通过sendAccessibilityEvent('requestFocusForAccessibility')在无焦点时自动指定默认聚焦目标。
焦点热区大小	

- 焦点热区过小：建议将语义一致、操作热区更大的父组件通过accessibilityGroup封装为整体焦点单元。
...
AccessibilityCheckedCase01.ets
...
AccessibilityCheckedCase02.ets
...
AccessibilitySelectedCase01.ets
...
AccessibilitySelectedCase02.ets
...
AccessibilityNextFocusIdCase01.ets
...
AccessibilityNextFocusIdCase02.ets
说明
...
AccessibilityScrollTriggerableCase01.ets
...
AccessibilityScrollTriggerableCase02.ets
设置无障碍焦点绘制图层层级
...
AccessibilityFocusDrawLevelCase01.ets
...
AccessibilityFocusDrawLevelCase02.ets
无障碍方法开发指导
...
OnAccessibilityFocusCase01.ets
无障碍触屏事件回调
...
AccessibilityActionInterceptCase01.ets
...
AccessibilityActionInterceptCase02.ets
主动聚焦
...
SendAccessibilityEventCase01.ets
...
SendAccessibilityEventCase02.ets
主动播报
...
SendAccessibilityEventCase03.ets

示例2：当 Button 组件的文本内容发生变化时，通过调用accessibility.sendAccessibilityEvent方法，发送announceForAccessibility类型的无障碍事件，触发屏幕朗读主动播报 “播放”/“暂停”，实现按钮文本内容变化与播报同步的效果。
...
SendAccessibilityEventCase04.ets
开关状态查询及监听
