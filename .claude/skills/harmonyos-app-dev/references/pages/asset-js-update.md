...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-update_

开发者可以查阅API文档，获取关键资产更新接口的详细说明：update(query: AssetMap, attributesToUpdate: AssetMap)、同步接口updateSync(query: AssetMap, attributesToUpdate: AssetMap)。
