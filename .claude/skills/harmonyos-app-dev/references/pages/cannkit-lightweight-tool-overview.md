...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-lightweight-tool-overview_
...
- 校准集
	...
	Quant_INT8-8	TensorFlow无训练量化	无需TensorFlow编写代码，新手开发者友好
...
- 开发者需要在训练工程中调用轻量化工具API量化模型并进行重训练
	...
	Quant_INT8-8	TensorFlow插件式量化	模型精度可保障
- 需要自动生成符合需求的网络结构	
...
- 开发者需要根据说明书编写模型接口代码
	...
	搜索生成网络结构	网络结构搜索训练	可根据开发者提供的配置信息自动搜索到在特定场景上表现优秀的网络结构
PyTorch开发者
开发者场景	使用依赖	工具链提供功能	建议使用工具	优势
...
- 校准集
	...
	Quant_INT8-8	PyTorch无训练量化	无需PyTorch编写代码，新手开发者友好
...
- 开发者需要调用轻量化工具API量化模型并进行重训练
	...
	Quant_INT8-8	PyTorch插件式量化	模型精度可保障
- 需要自动生成符合需求的网络结构	
...
- 脚本执行量化
	...
	Quant_INT16-4	大语言模型低位量化	超大规模模型，权重压缩至4bit
ONNX开发者
...
- 校准集
	...
	Quant_INT8-8	ONNX模型无训练量化	无需编写代码，新手开发者友好
模型轻量化
无训练量化
