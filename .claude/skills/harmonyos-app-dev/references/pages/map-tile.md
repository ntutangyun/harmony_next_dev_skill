...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-tile_
...
瓦片图层功能主要由TileOverlayParams、TileOverlayOptions、addTileOverlay和TileOverlay提供，更多接口及使用方法请参见接口文档。
