...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-skills_
...
操作步骤
点击界面右上方按钮，或者点击界面右上方Settings按钮，选择Skills，进入配置页面。

在Global Skills或Project Skills下，首次导入时，点击Import导入技能文件；若已存在技能文件，点击按钮进行导入。
...
在Global Skills和Project Skills列表中，显示已导入的技能信息，包括技能名称（如openharmony-build）、描述信息、启用状态。同时，将鼠标悬浮在技能信息上会显示编辑和删除的操作按钮，点击可在代码编辑区打开SKILL.md文件。
