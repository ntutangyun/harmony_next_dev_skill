...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/uiability-intra-device-interaction_
...
在系统配置文件route_map.json中配置子页信息（参考系统路由表）。
