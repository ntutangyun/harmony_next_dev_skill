...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/payment-common-pay-introduction_
...
三方支付方式配置项。是否SDK方式拉起收银台

- 是：基于接口拉起三方支付收银台

- 否：基于URL跳转三方支付收银台。

说明： 不同的配置在拉起三方支付收银台方式上有区别，当前支持基于接口拉起方式拉起三方支付收银台支持的支付方式参见PayMethod。


支付方式跳转路径	否	

三方支付方式配置项。基于URL跳转三方支付收银台方式时必选。
...
三方支付方式配置项。基于URL跳转三方支付收银台 方式时必选。
