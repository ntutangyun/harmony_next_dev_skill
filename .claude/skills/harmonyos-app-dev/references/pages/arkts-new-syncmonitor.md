...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-syncmonitor_
...
@SyncMonitor可以观察内置类型Map、Set、Date以及Array类型API调用引起的数据变化，详情参见通用监听能力。
...
CompareSyncMonitorWithMonitor.ets
...
MonitorVariablesInObservedV2Class.ets
...
MonitorTwoLayerVariablesInObservedV2Class.ets
...
MonitorVariableInBaseDerivedClass.ets
通用监听能力
...
MonitorVariablesInMultidimensionalArrays.ets
...
MonitorEntireObjectChangeButPropertyNoChange.ets
...
WildcardMonitorObjectPropertyChange.ets
...
WildcardMonitorArrayItemChange.ets
...
WildcardMonitorNestedObjectPropertyChange.ets
...
WildcardMonitorArrayFirstItemChange.ets
限制条件
...
MonitorTheSameVariableTwoTimes.ets
...
EffectiveAndIneffectiveTimesOfVariableMonitoring.ets
...
MonitorVariableFromAccessibleToInaccessible.ets
