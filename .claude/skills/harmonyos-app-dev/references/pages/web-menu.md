...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-menu_
...
创建一个EditMenuOptions对象，包含onCreateMenu和onMenuItemClick两个方法，通过Web组件的editMenuOptions接口与Web组件绑定。
