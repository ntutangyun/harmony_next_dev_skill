...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/share-utd-link_

在应用配置文件（src/main/module.json5）的skills配置中增加关联配置。参见：声明应用关联的网站域名。
...
目标应用处理App Linking。参见：拉起方实现跳转指导。
