...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/pipwindow-native_
...
Node-API模块注册，具体使用请参考Native API在应用工程中的使用指导。
...
示例中的视频播放需要使用AVPlayer，具体实现可参考视频播放。
