...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/web-focus_

开发者可利用Web组件的焦点管理功能，有效管理Web组件的获焦与失焦，同时利用H5端的W3C标准接口，管理网页界面上唯一可交互的元素获焦与失焦。

Web组件与ArkUI组件焦点控制的常用接口及其使用场景：

通过requestFocus主动请求Web组件获焦：当应用内有多个组件时，开发者可通过Web组件的requestFocus接口，主动将焦点转移到Web组件。
