...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-foreach_
...
说明
ArkUI框架会对重复的键值发出运行时警告。在UI更新时，如果出现重复的键值，框架可能无法正常工作，具体请参见渲染结果非预期。
不建议在键值中包含数据项索引index，这可能会导致渲染结果非预期和渲染性能降低。
