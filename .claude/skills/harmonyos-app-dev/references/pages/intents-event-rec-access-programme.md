...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/intents-event-rec-access-programme_
...
华为侧会根据事件和具体场景制定事件服务推出规则和时机。

在满足制定规则场景下展示对应用户事件，增加服务曝光率。

意图注册

以还款待办事件提醒特性为例，首先要注册查看还款意图（ViewRepayment），详见各垂域意图Schema。
