...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/iap-skill-introduction_
...
下载Skill，将下载到本地的Skill文件夹复制到AI编码工具的skills目录（不同工具规范不一致，按工具要求处理），工具就能在对话中自动或按需使用。
