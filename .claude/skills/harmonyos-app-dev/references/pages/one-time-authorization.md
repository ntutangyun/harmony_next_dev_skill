...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/one-time-authorization_
...
当应用切换至前台、应用展开卡片且处于当前屏幕可见即卡片可见或者设置后台长时任务的时候（当前仅支持定位导航长时任务），应用的临时权限会一直保持。
