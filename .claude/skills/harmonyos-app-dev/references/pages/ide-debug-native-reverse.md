...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-debug-native-reverse_
...
在File > Settings（macOS为DevEco Studio > Preferences/Settings） > Build,Execution,Deployment > Debugger > C++ Debugger设置界面，勾选Enable time travel debug开启C++反向调试开关。
