...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/scenario-fusion-api-followcomponent_
...
在华为开发者联盟服务号管理首页，申请华为服务号，并获取服务号id。
...
以下是关注组件的接口说明，更多接口及使用方法请参见atomicService（融合场景化API）。
