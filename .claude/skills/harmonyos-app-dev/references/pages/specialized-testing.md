...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/specialized-testing_
...
视频播放过程中的卡顿情况，卡顿时长大于100ms视为1次卡顿。
...
场景化性能测试的性能指标检测能力与性能基础质量测试一致；详情请查看性能基础质量测试。
