...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-variable-refreshrate_
...
基础解码功能请参考视频解码开发指南，下面仅针对于基础视频解码过程中存在的区别做具体说明。

解码器配置阶段，添加视频可变帧率使能开关。

示例中的变量说明如下：

• videoDec：视频解码器实例的指针。创建方式参考Surface模式下创建解码器实例对象。
