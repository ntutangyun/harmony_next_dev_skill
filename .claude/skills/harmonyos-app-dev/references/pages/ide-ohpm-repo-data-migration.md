...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-repo-data-migration_
...
使用第2步生成的pkgInfo_xxxx.json作为batch_download命令参数，批量下载har或tgz包，在命令执行目录生成batch_download_xxx.zip文件。
