...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/faq_
...
设备系统版本为HarmonyOS 5.0及以上。
PC与本地设备通过USB连接，设备需要进入设置-系统-开发者模式，开启开发者模式和USB调试权限。
将 DevEco Testing 安装目录下的 hdc 路径配置至系统环境变量中。
在CMD窗口中执行hdc list targets命令，可以识别到设备。
...
Q6：Mac版本客户端如果覆盖安装后，报错“‘DecEco_Testing_for_App’ 已损坏，无法打开。你应该将它移到废纸篓。”，如何解决？
