...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-automappingfndynamic_
...
若原始TensorFlow算子与适配AI处理器的算子属性无法一一映射，AutoMappingFnDynamic函数无法应用于回调函数ParseParamsByOperatorFn中，此种场景下，请在回调函数中使用AutoMappingByOpFnDynamic接口进行可以映射成功的属性的自动解析，使用示例请参见调用示例。
