...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-cpp_
...
从DevEco Studio 6.0.1 Beta1版本开始，新增"-iclang"参数，提升编译效率，具体请参考通过IClang提升C++增量编译效率。
...
请勿将源码等文件放置在该路径下，可能会被打包到产物中，请谨慎配置。
...
开启BinXO检测时，指定不需要进行二进制插桩的无源码so文件，支持正则匹配，具体使用方式请参考使用HWASan检测内存错误。
