...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/js-framework-syntax-js_
...
方法	参数	描述
$watch	data: string, callback: string | Function	

观察data中的属性变化，如果属性值改变，触发绑定的事件。示例见$watch感知数据改变。
