...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/map-marker_
...
通过setAnnotationVisible方法可以控制Marker文字显隐，还可以通过isAnnotationVisible方法来获取Marker文字显隐的状态。
...
通过在MarkerOptions中设置collisionRule属性，可以设置标记的冲突处理规则。
...
调用on(type: 'markerDragStart' , callback: Callback<Marker>)方法监听标记是否开始拖拽。
