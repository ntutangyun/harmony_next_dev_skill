...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-template_
...
创建一个展示基础的Hello World功能的模板，构建基于HarmonyOS应用的跨平台应用包。更多信息请参见ArkUI-X概览。
...
用于基于HarmonyOS应用构建跨平台应用的依赖包。依赖包支持添加到已有的应用中。更多信息请参见ArkUI-X概览。
...
创建一个调用C++代码的示例工程，构建基于HarmonyOS应用的跨平台应用包。更多信息请参见ArkUI-X概览。
