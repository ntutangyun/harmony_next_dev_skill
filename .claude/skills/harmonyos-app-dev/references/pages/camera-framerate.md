...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-framerate_
...
（可选）通过PreviewOutput提供的getActiveFrameRate接口查询已设置过并生效的帧率。

仅通过setFrameRate接口显式设置过帧率才可查询当前生效帧率信息。
