...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/pageability-lifecycle_
...
Index.ets页面提供一个"terminateSelf"按钮，点击后调用featureAbility.terminateSelf接口关闭Ability，从而触发onDestroy生命周期回调。
