...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ui-design-navigation-customized-area_

从6.0.0(20)版本开始，导航组件支持设置标题栏的stackBuilder和bottomBuilder，允许开发者自定义标题栏样式，以匹配应用的视觉风格。
