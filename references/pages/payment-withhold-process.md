...
商户服务端按照商户模型调用Payment Kit服务端直连商户预签约或服务商预签约接口。

Payment Kit服务端返回预签约号（preSignNo）给商户服务端。

商户服务端构建contractStr参数返回给商户客户端。

商户客户端通过contractStr调用requestContract接口拉起Payment Kit签约收银台。
...
签约完成后，商户服务器后续可以调用Payment Kit服务端直连商户申请免密代扣/服务商申请免密代扣接口来完成扣款服务。
