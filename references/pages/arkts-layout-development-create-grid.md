...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-layout-development-create-grid_
...
首先，需要创建一个Scroller类型的对象gridScroller。

private gridScroller: Scroller = new Scroller();

然后，通过scroller参数绑定滚动控制器。
