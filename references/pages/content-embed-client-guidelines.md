...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/content-embed-client-guidelines_
...
基于OE格式文件加载OE文档，当OE格式文件为数据流存储时需先落盘至本地再使用此接口。
...
[h2]实现客户端OE对象和OE Extension交互

启动OE Extension：启动OE Extension组件。

查询OE Extension组件能力。

编辑文档：通知OE服务端启动UIAbility编辑文档。
