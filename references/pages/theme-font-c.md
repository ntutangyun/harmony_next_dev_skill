...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/theme-font-c_
...
在应用入口文件（默认工程中为EntryAbility.ets）中重写onConfigurationUpdate函数，以响应fontId变更，适配主题字体的切换和页面刷新，重写方式可参考主题字变更事件。
