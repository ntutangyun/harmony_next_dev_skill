...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/l10n-multilingual-resources_
...
为了确保接口返回值与用户设置保持一致，通常需要在@ohos.i18n (国际化-I18n)和@ohos.intl (国际化-Intl)接口中传入系统区域ID或系统区域对象。系统区域ID和系统区域对象传入的示例如下：
...
对于应用开发者，仅需关注资源配置，资源文件配置完成后，根据业务需求对资源进行访问。资源文件配置和资源匹配规则请参考资源分类与访问。
