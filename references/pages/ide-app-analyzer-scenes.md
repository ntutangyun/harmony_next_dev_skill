...
场景	子场景	检测指标/检测项	应用或元服务场景	自动或手动方式	说明
折叠开合	截断	参考UX规则	应用，元服务	自动，手动	从26.0.0 Beta1版本开始支持。 支持所有手机及对应的模拟器。
大图大字	从26.0.0 Beta1版本开始支持。 仅支持API 20及以上的双折叠、三折叠、Pura X Max手机和模拟器。
留白	从26.0.0 Beta1版本开始支持。 仅支持API 20及以上的双折叠、三折叠、Pura X Max手机和模拟器。
避让区遮挡	从26.0.0 Beta1版本开始支持。 支持所有手机及对应的模拟器。
基础	从26.0.0 Beta1版本开始支持。 支持所有手机及对应的模拟器。
