...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/usb-ddk-guidelines_
...
在所有请求处理完毕，程序退出前，使用 usb_ddk_api.h 的 OH_Usb_DestroyDeviceMemMap 接口销毁缓冲区。使用OH_Usb_ReleaseInterface释放接口。使用OH_Usb_Release释放UsbDdk。
