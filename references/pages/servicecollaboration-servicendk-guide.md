...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/servicecollaboration-servicendk-guide_
...
通过HMS_ServiceCollaboration_GetCollaborationDeviceInfos接口获取支持相关能力的设备列表。

通过HMS_ServiceCollaboration_StartCollaboration接口拉起跨设备互通能力。
