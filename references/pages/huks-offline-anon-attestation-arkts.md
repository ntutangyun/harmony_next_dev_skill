...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-offline-anon-attestation-arkts_
...
将密钥别名与参数集作为参数传入anonAttestKeyItemOffline方法中，即可进行离线匿名密钥证明。
