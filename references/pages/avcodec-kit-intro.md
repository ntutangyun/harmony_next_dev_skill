...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/avcodec-kit-intro_
...
媒体数据解析支持模拟器，具体规格参考解封装格式。

媒体数据封装支持模拟器，具体规格参考封装格式。

视频编解码仅软件解码支持模拟器（h265格式除外），具体规格参考视频解码。

音频编解码支持模拟器，具体规格参考音频编解码。
