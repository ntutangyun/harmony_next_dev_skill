...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/using-avsession-developer_
...
接口名	说明
createAVSession(context: Context, tag: string, type: AVSessionType, callback: AsyncCallback<AVSession>): void10+	
...
FixedPlaybackControlCommands.ets
...
AdvancedPlaybackControlEvents.ets
