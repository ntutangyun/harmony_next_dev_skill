...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/performance-analysis-kit-terminology_
...
记录线程执行到当前现场（如崩溃、冻屏等）的函数调用顺序。具体说明请参见调用栈帧内容说明和JS混合栈帧内容说明。
