...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-travel-scene-view_
...
调用queryPass接口查询出行凭证信息。如果已经开通过该卡片，展示“去查看”按钮，点击后调用viewPass接口跳转钱包出行凭证详情页。
