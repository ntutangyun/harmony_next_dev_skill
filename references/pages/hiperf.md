...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiperf_
...
采集操作启停控制参数。命令包括prepare/start/stop。该参数不能和-d一起使用。
