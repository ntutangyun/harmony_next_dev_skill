...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/purgeable-memory-guidelines_
...
通过该机制提供的Native层相关接口申请并管理PurgeableMemory对象，并将数据内容写入该对象。

使用完毕后释放PurgeableMemory对象。
...
以下步骤描述了在HarmonyOS中如何使用Purgeable Memory提供的Native层相关接口，申请PurgeableMemory对象，并将内容写入PurgeableMemory对象后，对该对象进行读写访问。
