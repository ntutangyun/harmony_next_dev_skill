...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-valuedepend_
...
仅支持对算子输入配置，且仅支持输入的DataType配置为DT_INT64/DT_FLOAT/DT_BOOL。
