...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-prompts_
...
点击界面右上方Settings按钮，选择Prompts。

在代码编辑区右键唤醒菜单栏，点击CodeGenie > Add New Prompts。

点击Add Now进入Prompts配置页面。

填写提示词名称、提示词内容等，点击Save进行保存。
