...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/public-audio-spatialization-management_
...
应用开发者在使用AudioSpatializationManager的接口前，需要先调用getSpatializationManager创建AudioSpatializationManager实例。
