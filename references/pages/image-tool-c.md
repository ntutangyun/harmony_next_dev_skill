...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-tool-c_
...
系统目前仅支持对部分Exif信息的查看和修改，具体支持的范围请参见：变量里的OHOS_IMAGE_PROPERTY_XXX类型。需要注意的是，DNG格式图片仅支持读取Exif信息，不支持修改。
...
Exif信息的读取与编辑相关C API接口的详细介绍请参见OH_ImageSourceNative_GetImageProperty()和OH_ImageSourceNative_ModifyImageProperty()。
