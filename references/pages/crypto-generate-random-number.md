...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-generate-random-number_
...
（可选）设置DataBlob数据，调用Random.setSeed，为随机数生成池设置种子。

设置指定字节长度，调用Random.generateRandom或Random.generateRandomSync，生成安全随机数。
