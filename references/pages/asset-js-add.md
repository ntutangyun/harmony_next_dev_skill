...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-add_

开发者可以查阅API文档，获取关键资产新增接口的详细说明：add(attributes: AssetMap)、同步接口addSync(attributes: AssetMap)。
