...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/pseudo-i18n-testing-translation_
...
检查多语言文字显示问题。如果伪翻译文字未能正常显示，出现类似方块、空白或文字显示不完整等现象，说明多语言显示存在异常。
