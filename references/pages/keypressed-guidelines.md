...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/keypressed-guidelines_
...
按键按下事件常用接口如下表所示，接口详细介绍请参考@ohos.multimodalInput.inputConsumer。
