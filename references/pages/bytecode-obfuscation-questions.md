...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/bytecode-obfuscation-questions_
...
若确认是开启混淆后功能出现的异常，请先阅读文档了解混淆规则的能力以及哪些语法场景需要配置白名单来保证应用功能正常。
