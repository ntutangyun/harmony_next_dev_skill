...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cloud-sync-file-overview_
...
针对应用开发者，端云文件协同提供文件的同步、单点与批量缓存等核心能力接口，应用只需将待上云的文件放在沙箱目录/data/storage/el2/cloud下，即可自动完成文件的上云，其余基础文件操作接口，请参考应用文件访问与管理开发指南。
