...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/push-specification_
...
应用使用Push Kit时，推荐接入应用内通知设置快捷入口，便于用户找到应用内的通知分类控制开关，提升用户通知管理的体验，减少应用通知关闭率。
