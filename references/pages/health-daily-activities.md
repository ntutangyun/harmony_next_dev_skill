...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/health-daily-activities_

此数据记录用户在一小段时间内的日常活动数据。

说明

Wearable设备暂不支持该数据类型。读取实时日常活动数据使用读取实时三环数据接口。
...
字段定义：samplePointHelper.dailyActivities.Fields
