...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-batch-update_

接口介绍

从版本26.0.0开始，系统提供异步接口batchUpdate以便开发者批量更新关键资产。
...
批量更新的关键资产必须具有相同的GROUP_ID和REQUIRE_ATTR_ENCRYPTED属性。
