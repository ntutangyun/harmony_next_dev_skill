...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ndk-development-overview_
...
获取NDK开发包，请参考NDK开发工具目录。

build目录：放置预定义的toolchain脚本文件hmos.toolchain.cmake
