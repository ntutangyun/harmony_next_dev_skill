...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-region-and-downsampling-c_
...
参考使用Image_NativeModule完成图片解码创建OH_ImageSourceNative实例。

设置cropRegion参数执行区域解码。
...
参考图片开发指导(C/C++)创建OH_ImageSourceNative实例。

设置desiredSize参数执行下采样解码。
...
同时设置cropRegion、desiredSize和cropAndScaleStrategy参数。
