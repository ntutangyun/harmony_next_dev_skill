...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/create-cms-sign-object_
...
调用cmsGenerator.addSigner添加签名者信息。

调用cmsGenerator.addCert添加证书。

调用cmsGenerator.doFinal获取Cms最终签名数据。
