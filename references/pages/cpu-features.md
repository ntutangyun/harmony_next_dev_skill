...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cpu-features_
...
在HarmonyOS系统C++工程中引入开源库，下载cpu_features库，解压到工程的cpp目录下，解压后的文件名改为cpu_features。如下以DevEco Studio C++模板示例应用举例：
