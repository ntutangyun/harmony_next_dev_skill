...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-file-upload-download_
...
开发者可以通过调用PhotoAccessHelper模块描述的createAsset()接口创建媒体文件并获取用户文件的URI，将其作为Config的saveas字段值进行下载。

需要权限：ohos.permission.WRITE_IMAGEVIDEO

权限ohos.permission.WRITE_IMAGEVIDEO是权限机制中的基本概念中system_basic(系统基础服务)级别的受限开放权限，normal等级的应用需要将自身的APL等级声明为system_basic及以上。授权方式为user_grant，需要向用户申请授权。
