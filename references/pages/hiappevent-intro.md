...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-intro_
...
目前应用有普通应用、应用分身、元服务、输入法应用等多种类型，不同类型应用上，系统事件的订阅规格不同。从API version 22开始，HiAppEvent系统事件订阅能力支持输入法应用。具体规格可参见如下表格：
