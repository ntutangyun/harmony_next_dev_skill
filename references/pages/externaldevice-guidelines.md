...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/externaldevice-guidelines_
...
创建新工程，请参考创建一个新的工程，创建一个HarmonyOS工程。
...
接下来请参考开发无UI界面基础驱动，进行对应驱动的示例代码开发。
...
在AGC网站菜单“证书、APP ID和Profile”->“Profile”中申请profile文件时，申请权限选择受限权限“ohos.permission.ACCESS_DDK_DRIVERS”，在该权限的输入框内填写你客户端需要连接的服务端的bundleName，多个服务端的bundleName以逗号分隔。
