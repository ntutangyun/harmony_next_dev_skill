...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-hotel-scene-view_
...
调用queryPass接口查询酒店房卡信息。如果已经开通过该卡片，展示“去查看”按钮，点击后调用viewPass接口跳转钱包酒店房卡详情页。
