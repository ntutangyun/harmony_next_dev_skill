...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-extension-key-import-arkts_
...
调用importWrappedKeyItem导入加密封装的密钥对，密钥参数中需指定HUKS_TAG_KEY_CLASS为HUKS_KEY_CLASS_EXTENSION，表示该密钥由外部密钥管理扩展管理。
