...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-packer-c_
...
部分接口（如：OH_ImagePackerNative_GetSupportedFormats）在API version 20以后才支持，需要开发者在进行开发时选择合适的API版本。
