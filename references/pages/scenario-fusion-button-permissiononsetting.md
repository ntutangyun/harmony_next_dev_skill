...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/scenario-fusion-button-permissiononsetting_
...
调用requestPermissionsFromUser接口，用户在首次权限设置弹框时拒绝授权。
