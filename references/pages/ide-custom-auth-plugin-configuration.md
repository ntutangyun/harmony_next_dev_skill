...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-custom-auth-plugin-configuration_
...
进入ohpm-repo解压根目录，把模板文件中tsconfig.json 文件移动到ohpm-repo解压根目录。
...
ohpm-repo服务部署。在完成上述操作之后，按照ohpm-repo部署指导，完成服务部署。
