...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/canvas-get-result-draw-arkts_
...
重写自定义RenderNode的draw()函数，获取Canvas进行自定义的绘制操作，即本章下文中的内容。
...
重写自定义RenderNode的draw()函数，在其中获取离屏Canvas进行绘制：
