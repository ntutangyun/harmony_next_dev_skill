...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-playback-overview_
...
OHAudio：用于音频输出的Native API，此API在设计上实现归一化，同时支持普通音频通路和低时延通路。仅支持PCM格式，适用于依赖Native层实现音频输出功能的场景。
