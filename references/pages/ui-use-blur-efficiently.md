...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ui-use-blur-efficiently_
...
对背景图片应用backgroundEffect接口设置模糊效果；

设置adaptiveColor属性值为AdaptiveColor.AVERAGE。
...
根据pixMap创建ColorPicker；

调用ColorPicker的getAverageColor()方法获取颜色，转换成backgroundEffect接口参数color的格式，调用接口时替换成获取到的blurColor。
