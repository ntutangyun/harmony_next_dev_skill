...
openMapOfflineDataManagement(context: common.Context, offlineDataParams: OfflineDataParams): Promise<void>	打开地图应用的离线数据管理页面。
地图应用使用的坐标类型
...
通过openMapOfflineDataManagement，传入离线数据管理参数，打开地图应用离线数据管理页面。
