...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-supports-rectangular-area-recording_
...
调用OH_AVScreenCapture_SetCaptureArea()接口传入希望录制的矩形区域。

示例中的变量说明如下：

g_avCapture：指向OH_AVScreenCapture实例的指针。
