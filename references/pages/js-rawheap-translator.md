...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/js-rawheap-translator_
...
将本地存放js_rawheap_translator工具的文件路径填至新建的文本框中。
