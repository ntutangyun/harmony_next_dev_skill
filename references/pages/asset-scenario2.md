...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-scenario2_
...
查询关键资产明文，开发步骤包括预处理、用户认证、查询明文、后置处理，参考查询需要用户认证的关键资产。
