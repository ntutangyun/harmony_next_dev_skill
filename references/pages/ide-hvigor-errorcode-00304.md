...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-errorcode-00304_
...
检查pkgContextInfoPath对应的文件是否存在，如果不存在，重新下载DevEco Studio。
...
检查报错信息中的文件是否存在，如果不存在，在官网上重新下载DevEco Studio。
...
点击File > Sync and Refresh Project重新Sync工程。
...
点击Build > Clean Project删除缓存后重新构建，检查文件是否生成。
