...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-package-glossary_
...
[h2]Static Library；静态共享库

Library类型模块，编译后生成HAR文件，代码和资源跟随使用方编译，编译态复用。

[h2]Shared Library；动态共享库
