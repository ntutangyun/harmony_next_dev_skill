...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-file-backup-overview_
...
应用本身无法触发数据的备份和恢复，仅能进行备份恢复的配置。在应用克隆和应用数据迁移中会触发数据备份恢复，应用本身接入数据备份恢复即可。如需验证接入效果请参考应用数据备份恢复验证指导。
