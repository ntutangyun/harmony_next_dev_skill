...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/agc-harmonyos-clouddev-emptyability_
...
由于端云一体化开发工程的初始化代码未配置AccessToken，因此您还需配置云存储的安全策略为始终可读写，否则会导致云存储无法上传文件。具体操作如下：
