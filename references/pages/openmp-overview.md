...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/openmp-overview_
...
当前HarmonyOS中的OpenMP库采用llvm 15.0.4中的实现，对应OpenMP API版本请参考clang-OpenMPSupport。

HarmonyOS应用中使用OpenMP请参考OpenMP应用构建和运行指南。
