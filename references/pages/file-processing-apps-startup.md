...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/file-processing-apps-startup_
...
ohos.ability.params.showDefaultPicker	boolean	
...
表示调用方本身作为目标方应用匹配成功时，是否在打开文件的应用选择弹框中展示，缺省为false。
