...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/synchronous-video-encoding_
...
视频编码的限制约束、支持的能力、状态机调用关系请参考视频编码。
...
nativeWindow：获取方式请参考视频编码Surface模式的“步骤-6：设置surface”。
