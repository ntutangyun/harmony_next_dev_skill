...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-config-errorcode_

以下划线开头键名受保护（如_auth=readWriteToken），不允许访问。详情可参考如何配置AccessToken。
