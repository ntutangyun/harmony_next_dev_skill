...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/health-pressure_

此数据记录用户在某一刻的压力数据，每一条数据都代表该时刻的压力状态。

Harmony SDK类型常量：samplePointHelper.stress.DATA_TYPE
...
字段定义：samplePointHelper.stress.Fields
...
字段定义：samplePointHelper.stress.AggregateFields
