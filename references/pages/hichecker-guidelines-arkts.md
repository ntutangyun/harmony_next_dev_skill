...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hichecker-guidelines-arkts_
...
子系统有耗时调用或者Ability资源泄漏时通过HiChecker通知有对应规则的事件发生，HiChecker检测条件满足时做对应的操作。
...
检测模式接口由HiChecker模块提供，详细API请参考@ohos.hichecker。
