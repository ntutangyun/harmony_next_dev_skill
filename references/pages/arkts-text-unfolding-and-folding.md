...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-text-unfolding-and-folding_
...
本示例使用measureTextSize()方法判断文字的高度，从API version 20开始，新增getParagraphs20+方法测算文本。getParagraphs()方法代码量更少，更直观的获取显示行数。
