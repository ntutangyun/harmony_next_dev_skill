...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/intents-habit-rec-dp-self-validation_
...
开发者在AppGallery Connect平台上提交的习惯推荐方案能力申请审核成功后，可根据审核成功的反馈提示，提供测试应用的信息。能力申请的步骤参考Intents Kit接入流程。
...
【举例】某音乐App接入意图框架音乐续播的特性。通过播放某一首歌曲的用户操作，触发某音乐App调用系统接口shareIntent()。开发者可通过接口回调的信息来确认本次意图共享是否成功。
