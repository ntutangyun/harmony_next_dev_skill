...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/crypto-sm2-sign-data-format-conversion_
...
构造EccSignatureSpec对象，用于指定SM2密文参数。

调用genEccSignature，将EccSignatureSpec对象传入，转换为DER格式的SM2密文。
