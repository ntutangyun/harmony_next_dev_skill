...
配置Proxy代理
在欢迎页单击Customize > All settings… > Appearance & Behavior > System Settings > HTTP Proxy进入HTTP Proxy设置界面。如果已经打开了工程，可以单击File > Settings（macOS为DevEco Studio > Preferences/Settings） > Appearance & Behavior > System Settings > HTTP Proxy进入HTTP Proxy设置界面。
