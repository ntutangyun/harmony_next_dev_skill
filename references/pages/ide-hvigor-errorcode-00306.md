...
在hvigor-config.json5中调整线程相关配置：hvigor.pool.maxSize、ohos.arkCompile.maxSize、hvigor.enableMemoryCache。
...
通过pickFirsts、pickLasts或select字段设置.so文件的优先级。
