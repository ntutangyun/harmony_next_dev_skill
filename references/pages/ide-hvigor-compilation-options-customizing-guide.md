...
构建模式使用的具体配置信息，详情请参见工程级buildOption。
...
构建模式使用的具体配置信息，详情请参见模块级buildOption，其中不支持配置name、debuggable和copyFrom字段。
...
构建模式使用的具体配置信息，详情请参见模块级buildOption，其中不支持配置name、debuggable和copyFrom字段，优先级比buildOptionSet更高。
