...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-custom-env-property_
...
点击'change message'更改message的值，当前正在显示的TabContent组件中的@Monitor中注册的方法onStrChange被触发。

点击TabBar中的'tab1'切换到另外的TabContent，TabContent状态由inactive变为active，对应的@Monitor中注册的方法onStrChange被触发。

再次点击'change message'更改message的值，仅当前显示的TabContent子组件中的@Monitor中注册的方法onStrChange被触发。其他inactive的TabContent组件不会触发@Monitor。
