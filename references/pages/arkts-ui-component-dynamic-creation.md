...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-component-dynamic-creation_
...
相比之下，使用ArkUI的自定义组件节点 (FrameNode)，可以避免创建自定义组件对象和状态变量对象，无需进行依赖收集，从而显著提升组件创建的速度。
...
实现NodeController，用于自定义节点的创建、显示、更新等操作的管理，并负责将自定义节点挂载到NodeContainer上。
...
更新自定义节点，可参考BuilderNode的update()方法。
