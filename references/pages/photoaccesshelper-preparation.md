...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/photoaccesshelper-preparation_
...
上述权限ohos.permission.READ_IMAGEVIDEO和ohos.permission.WRITE_IMAGEVIDEO为受控权限，通常是不允许三方应用申请的。如果有特殊场景需要使用，请提供相关申请材料到AppGallery Connect（AGC）申请相应权限证书。申请前请参考受限开放权限，确保应用符合可申请的场景。然后再参考申请受限权限，完成受限开放权限的申请。
