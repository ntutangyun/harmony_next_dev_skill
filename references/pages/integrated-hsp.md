...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/integrated-hsp_
...
模块配置：修改模块级构建配置文件build-profile.json5，将integratedHsp配置项设置为true，指定构建的HSP模块为集成态HSP。
