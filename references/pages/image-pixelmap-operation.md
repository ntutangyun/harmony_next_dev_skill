...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-pixelmap-operation_
...
位图操作相关API的详细介绍请参见PixelMap。

完成图片解码，获取PixelMap位图对象。
...
完成图片解码，获取两张宽度相同且像素格式相同的PixelMap位图对象。
