...
创建HarmonyOS应用工程，仅支持创建工程模板中的Empty Ability模板。
...
启动模拟器。首次使用时，需要签署HarmonyOS软件许可与服务协议，具体请参考emulator license accept。
...
下载模拟器镜像。首次使用时，需要签署HarmonyOS SDK许可协议，具体请参考emulator license accept。
