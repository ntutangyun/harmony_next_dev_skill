...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-deveco-code-common-configure_
...
在DevEco Code对话框输入/skills可查看所有Skill。DevEco Code已内置部分Skill，如下表，同时也支持自定义创建Skill。
