...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-debug-arkts-debugger_

Debug界面有三个tab页，分别是“entry”、“entry(PandaDebugger)”和“entry(Native)”。

通常第一个tab页“entry”用于展示推包安装过程。

第二个tab页“entry(PandaDebugger)”和第三个tab页“entry(Native)”是调试器，用于调试Debugger功能，其中“entry(Native)”仅在涉及Native调试时才会拉起。调试器包含两个窗格，Debugger和Console。
...
按钮	名称	快捷键	功能
	...
	JSVM Debug Port	无	转发JSVM调试的端口，转发后可以在浏览器的DevTools工具上进行JSVM-API调试。 说明： 仅Native调试器中支持该按钮。
