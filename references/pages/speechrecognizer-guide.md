...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/speechrecognizer-guide_
...
createEngine方法提供了两种调用形式，当前以其中一种作为示例，其他方式可参见speechRecognizer.createEngine。
...
得到SpeechRecognitionEngine实例对象后，实例化RecognitionListener对象，然后调用setListener方法设置回调，用来接收语音识别相关的回调信息。
