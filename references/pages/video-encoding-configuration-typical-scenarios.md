...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-encoding-configuration-typical-scenarios_
...
videoEnc：视频编码器实例的指针。创建方式可参考视频编码Surface模式“步骤-2：创建编码器实例对象”。
