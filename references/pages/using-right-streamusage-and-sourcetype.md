...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/using-right-streamusage-and-sourcetype_
...
系统根据不同的用户使用场景和音频流的参数信息，提供多种音频通路选择。系统通过应用指定的StreamUsage和SourceType提供对应的场景信息，结合音频流的采样率、声道数、编码格式等参数，选择合适的音频通路。
