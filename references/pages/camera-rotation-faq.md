...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/camera-rotation-faq_
...
在会话配置过程中，未适配相机预览旋转接口：getPreviewRotation、setPreviewRotation。

会话配置过程中的时序不正确，即调用相机预览旋转接口前未完成会话commitConfig。

相机窗口发生旋转时，未适配相机预览旋转接口。

getPreviewRotation、setPreviewRotation接口入参错误。
