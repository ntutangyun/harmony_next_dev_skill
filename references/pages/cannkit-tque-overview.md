...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-tque-overview_
...
队列的深度表示该队列可以连续入队/出队操作的最大次数，在代码运行时，对同一个队列有n次连续的EnQue（中间没有DeQue），那么该队列的深度就需要设置为n。
