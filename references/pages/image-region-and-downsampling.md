...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/image-region-and-downsampling_
...
参考使用ImageSource完成图片解码创建ImageSource实例。

设置desiredRegion参数执行区域解码。
...
同时设置desiredRegion、desiredSize和cropAndScaleStrategy参数。
