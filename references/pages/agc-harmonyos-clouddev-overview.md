...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/agc-harmonyos-clouddev-overview_
...
部署云侧工程：云侧工程代码开发调试完毕后，一键部署云侧工程到AGC云端。
开发端侧工程：在端侧工程下通过Cloud Foundation Kit调用部署的云侧代码，包括调用云函数、调用云对象、访问云数据库、调用云存储。
