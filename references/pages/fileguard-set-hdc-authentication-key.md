...
从6.1.1(24)版本开始，新增设置HDC认证密钥接口，支持用户在企业设备上开展安全调试，进一步强化设备安全性。
...
初始化FileGuard对象guard，调用接口setHdcAuthenticationKey，设置上下位机之间的HDC认证密钥。上位机需要下发私钥，下位机下发公钥，从而实现上位机对下位机的安全调试。
