...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/user-authentication-overview_
...
设备间建立信任关系：伴随设备被用户在主设备上添加为自己的身份认证凭据。

伴随设备确认用户身份：伴随设备确认当前佩戴或操作者自己的用户是机主本人。

主设备确认机主授权：主设备通过伴随设备确认机主在附近或机主手动确认了操作。
...
各种认证能力：包括口令认证、人脸认证、指纹认证和伴随设备认证，分别实现了基于锁屏口令、人脸、指纹和伴随设备认证用户身份的能力，供统一用户认证框架调度。
