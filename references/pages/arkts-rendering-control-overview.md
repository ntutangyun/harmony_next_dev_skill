...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-overview_
...
ArkUI框架为鸿蒙应用开发者提供了ForEach组件（全量加载）和LazyForEach组件（懒加载）对列表数据循环渲染。除此之外，Repeat组件同时支持两种开发场景，并且默认具备组件复用能力。
