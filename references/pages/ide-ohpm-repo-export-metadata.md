# 导出OpenHarmony三方库中心仓元数据至ohpm

_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-ohpm-repo-export-metadata_
...
使用export_pkginfo 命令，导出OpenHarmony三方库中心仓已上架的包列表。
