...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-web-fling-jank-events_
...
从API version 23开始，ArkWeb抛滑丢帧事件支持在应用分身、元服务及输入法应用场景下使用 HiAppEvent 进行订阅。
