...
[h2]Enterprise Mobility Management (EMM)；企业移动管理
...
[h2]Mobile Device Management (MDM)；移动设备管理

狭义的MDM指手机、平板这类移动办公类终端设备的管理，广义的MDM泛指企业终端设备管理，包括PC、大屏、穿戴设备。

S

[h2]Super Device Admin (SDA)；超级设备管理员
