...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/onlineauthentication-ifaa_
...
IFAA服务会将匿名化的指纹ID和面容ID等个人信息返回至三方应用，以提供绑定具体生物特征的免密认证能力。应用将个人信息上云前，需要向用户明示并且取得同意，详细请参考个人数据处理说明。
