...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-hvigor-errorcode-00308_
...
报错信息包含"Remote sign har failed"，原因是hvigor-config.json5中配置ohos.sign.har为true后，流水线构建har时指定的JDK版本低于21。
...
请检查工程目录下.hvigor > outputs > build-logs目录下的详细报错日志进行分析。如果无法解决，通过在线提单提交问题，华为支持人员会及时处理。
