...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-local-test-errorcode_
...
运行配置取消了构建任务，本地没有modules.abc文件。

处理步骤

点击菜单栏Build > Clean Project清理缓存，再重新执行测试。
