...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wearengine_apply_
...
若选择需要兼容与旧版本穿戴应用通信的手机移动应用，则需填写归属于同账户下的待兼容应用与待兼容应用包名。
...
穿戴用户状态USER_STATUS （权限）

查询和订阅用户佩戴状态和订阅用户心率告警。

人体传感器HEALTH_SENSOR （权限）
...
数据使用说明：申请数据权限及使用说明（范例）个人开发者.xlsx、申请数据权限及使用说明（范例）企业开发者.xlsx。

用户授权路径说明：用户授权路径说明（范例）。
