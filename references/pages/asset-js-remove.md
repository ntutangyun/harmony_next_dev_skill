...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/asset-js-remove_

开发者可以查阅API文档，获取关键资产删除接口的详细说明：remove(query: AssetMap)、同步接口removeSync(query: AssetMap)。
