...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/huks-identity-authentication-overview_
...
HUKS_USER_AUTH_TYPE_TUI_PIN，即数字盾密码。简写为TUI_PIN。数字盾密码请参考数字盾服务。
