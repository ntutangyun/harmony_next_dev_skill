...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/scenario-fusion-button-get-risklevel_
...
应用开发前提条件，需要完成手机号的scope权限申请和【获取风险等级】权限申请，请见申请账号权限和开发前提章节。

元服务应用开发前提条件，需要完成手机号的scope权限申请和【获取风险等级】权限申请，请见申请账号权限和开发前提章节。
