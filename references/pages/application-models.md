...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/application-models_
...
进程模型	有两类进程： 1. 主进程 2. 渲染进程 详细介绍请参见进程模型。	包含主进程、ExtensionAbility进程、渲染进程等基本进程类型，以及其他进程类型。 详细介绍请参见进程模型。
