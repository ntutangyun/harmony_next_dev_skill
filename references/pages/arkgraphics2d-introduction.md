...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkgraphics2d-introduction_
...
图像效果处理：开发者可根据不同的UI效果需要，使用@ohos.effectKit (图像效果)实现图像的效果处理，以提升用户浏览体验。
