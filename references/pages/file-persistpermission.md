...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/file-persistpermission_
...
持久化授权的数据存储在系统的数据库中，应用或者设备重启后需要激活已持久化的授权才可以正常使用激活持久化授权。
