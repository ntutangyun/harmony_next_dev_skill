...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-common-events-focus-event_
...
点击Set Active按钮，调用activate接口进入焦点激活态。

Tab键走焦至Set Not Active按钮，Enter键触发按键事件，调用activate接口退出焦点激活态。
