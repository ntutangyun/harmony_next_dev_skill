...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/game-controller-monitor-pad_
...
通过OH_GamePad_AxisEvent_GetXAxisValue获取X轴的轴值。
...
通过OH_GamePad_AxisEvent_GetZAxisValue获取Z轴的轴值。
...
通过OH_GamePad_AxisEvent_GetHatXAxisValue获取HatX轴的轴值。
