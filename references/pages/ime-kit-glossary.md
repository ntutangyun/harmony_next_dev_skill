...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ime-kit-glossary_

B

[h2]Base experience mode; 基础访问模式

对输入法应用进行安全管控的模式约束，严格遵从仅提供基础打字功能。

C

[h2]CustomInput; 自定义输入框

开发者自定义的文本输入控件，通过集成InputMethodController实现与输入法的绑定。

D

[h2]DARK_IMMERSIVE; 深色沉浸模式
...
[h2]FLAG_FLOATING; 悬浮态

输入法面板可浮动移动的状态类型。

[h2]FLAG_CANDIDATE; 候选词态
