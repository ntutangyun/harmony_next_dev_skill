...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/password-shared-apps-web-pages_
...
接入参考：应用接入密码保险箱、网页接入密码保险箱

应用和网页通过App Linking完成关联关系的绑定。

接入需完成三步：在AGC控制台开通App Linking服务 > 建立域名与应用关联关系 > 在AGC为应用创建关联的网址域名
