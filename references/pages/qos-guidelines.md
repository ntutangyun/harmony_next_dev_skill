...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/qos-guidelines_
...
为某个任务设置指定的QoS等级。开发者可以根据当前任务的重要程度，为其标记不同等级的QoS，从而获得不同的调度供给。参考QoS实践指导。
