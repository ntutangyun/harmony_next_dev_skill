...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/smartperf-guidelines_
...
Device daemon端执行前需完成hdc环境配置，并进入shell环境拉起daemon进程。
...
工具使用说明请参见操作指导，请前往工具下载中心获取HiSmartPerf工具。
