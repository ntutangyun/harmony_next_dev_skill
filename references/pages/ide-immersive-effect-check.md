...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-immersive-effect-check_

若应用通过setWindowLayoutFullScreen()接口设置窗口布局，建议调用getWindowAvoidArea()和on('avoidAreaChange')获取和动态监听避让区域的变更信息，使页面布局根据避让区域信息进行动态调整。
