...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/hiappevent-watcher-app-launch-c_

接口说明

本文介绍如何使用HiAppEvent提供的C/C++接口订阅启动耗时事件。详细使用说明请参考HiAppEvent C API文档。
