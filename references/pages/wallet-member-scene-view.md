...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/wallet-member-scene-view_
...
调用queryPass接口查询会员卡信息。如果已经开通过该卡片，展示“去查看”按钮，点击后调用viewPass接口跳转钱包会员卡详情页。
