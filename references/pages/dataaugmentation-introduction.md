...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/dataaugmentation-introduction_
...
端侧问答模型：提供接入端侧模型问答的方法，以及使用AI模型管家对接LLM，对用户问题进行处理的过程，实现数据本地化智能问答的效果。
