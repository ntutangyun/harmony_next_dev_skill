...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-kit-intro_
...
音频流基础信息通过AudioStreamInfo表示，包括采样率、声道、位宽、编码信息，是创建音频播放或录制流的必要参数，描述了音频数据的基本属性。在配置时开发者需要保证基础信息与传输的音频数据相匹配，音频系统才能正确处理数据。
...
支持的音频采样率（Hz）：8000、11025、12000、16000、22050、24000、32000、44100、48000、64000、8820012+、96000，17640012+、19200012+具体参考枚举AudioSamplingRate。
