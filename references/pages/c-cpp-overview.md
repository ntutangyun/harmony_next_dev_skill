...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/c-cpp-overview_

HarmonyOS NDK提供业界标准库libc标准库、c++标准库，本文用于介绍C/C++标准库在HarmonyOS中的机制，开发者了解这些机制有助于在NDK开发过程中避免相关问题。
