...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/smart-photopicker_
...
选择特定类型（RecommendationType）的图片，如身份证、银行卡、驾驶证、行驶证、二维码等。当有符合应用指定类型的图片传入时，将显示对应的图片推荐页。
