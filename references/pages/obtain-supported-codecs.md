...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/obtain-supported-codecs_
...
按需调用相应的查询接口。详细的API说明请参考native_avcapability.h。
