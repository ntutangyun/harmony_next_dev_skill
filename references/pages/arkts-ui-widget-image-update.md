...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-ui-widget-image-update_
...
在WgtImgUpdateEntryFormAbility中的onAddForm生命周期回调中实现本地文件的刷新。
...
在WgtImgUpdateEntryFormAbility中的onFormEvent生命周期回调中实现网络文件的刷新。
...
在卡片页面通过backgroundImage属性展示WgtImgUpdateEntryFormAbility传递过来的卡片内容。
