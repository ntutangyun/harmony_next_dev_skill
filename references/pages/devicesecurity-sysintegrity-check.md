...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/devicesecurity-sysintegrity-check_
...
更多JWS的相关知识请参见JSON Web Signature。
...
从header中获取证书链，使用Huawei CBG Root CA G2证书对其进行验证。
