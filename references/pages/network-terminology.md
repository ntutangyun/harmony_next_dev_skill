...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/network-terminology_
...
[h2]Extensible Authentication Protocol (EAP)；可扩展认证协议
...
[h2]Network Handle (NetHandle)；网络句柄
...
[h2]Network Bearer Type (NetBearType)；网络承载类型

网络承载类型用于表示底层接入网络的类别，如蜂窝网络、Wi‑Fi、以太网、蓝牙或VPN等，用于区分不同类型的网络接入方式。

[h2]Network Probing；网络探测
