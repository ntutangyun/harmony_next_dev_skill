...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/audio-video-muxer_
...
设置OH_MD_KEY_TRACK_DESCRIPTION时，值必须为"com.openharmony."开头且长度不超过256个字符的字符串。
...
flv格式不支持调用OH_AVMuxer_SetRotation()设置旋转角度，调用将返回错误。
