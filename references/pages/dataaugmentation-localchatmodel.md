...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/dataaugmentation-localchatmodel_
...
当前端侧模型问答仅支持PC/2in1设备类型。

当前端侧模型问答仅对企业开发者提供申请能力。
...
申请ohos.permission.INTERNET权限，配置方式请参阅声明权限声明权限。
