...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/multi-window-intro_
...
当应用module.json5配置文件中的设备类型deviceTypes标签包含"2in1"且不包含"phone"时，系统判定其为PC应用。
...
应用自主启动分屏：除了通过手势触发分屏之外，应用可以自主选择启动分屏，具体步骤可见应用内分屏。
