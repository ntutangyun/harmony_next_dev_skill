...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/devicesecurity-detectsimulatedclickriskenhanced_
...
以下是模拟点击增强检测相关接口，更多接口及使用方法请参见API参考。
...
模拟点击增强检测接口响应结果，格式为JSON WEB签名（JWS）。验证检测结果完整示例可参考java示例代码，具体步骤如下：
