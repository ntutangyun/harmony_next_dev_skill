...
hidumper --mem-jsheap pid [-T tid] [--gc] [--leakobj] [--raw] [--clean]命令调试的进程应为“使用调试证书签名的应用”，同debug版本应用。
...
获取指定进程的虚拟机堆内存和泄露对象信息的前提是应用已通过@ohos.hiviewdfx.jsLeakWatcher接口开启了泄漏检测功能。
