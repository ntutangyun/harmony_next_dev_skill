...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/app-data-migration-adaptation_
...
终端设备从HarmonyOS升级到HarmonyOS NEXT中，会将原有APK应用沙箱目录中文件放置到HarmonyOS备份恢复目录。对应关系详见APK应用沙箱目录与备份恢复目录映射关系。
...
/data/user_de/{userId}/{APK包名}/	/data/storage/el1/base/.backup/restore/{APK包名}/de/	
