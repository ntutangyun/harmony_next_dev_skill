...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/intents-introduction_
...
为了满足更细粒度的分发诉求，每类特性类别下提供多个具体特性，具体特性的分发系统入口、开发依赖见各垂域的智慧分发特性列表。具体特性开发依赖的意图相关字段见各垂域意图Schema。
