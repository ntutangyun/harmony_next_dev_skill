...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/special-text-recognition-redirection_
...
在Text组件上启用enableDataDetector属性，即可实现对一段文字中的链接、日期、电话号码、地址、邮箱等特殊文本进行自动识别并标记。
