...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/video-smart-fluency-decoding_
...
本能力需主动下发配置才可以生效。通过在OH_AVFormat中配置以下键值对来精确控制行为。

OH_MD_KEY_VIDEO_DECODER_FRAME_RETENTION_MODE（模式配置）

类型：int32_t

取值范围：参考OH_FrameRetentionMode。
