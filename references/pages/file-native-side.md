...
_Source: https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/file-native-side_
...
方案一：ArkTS侧获取沙箱路径（详见获取应用文件路径）传递给Native侧访问文件。
方案二：Native侧直接拼接沙箱路径（详见应用沙箱路径和真实物理路径的对应关系）访问文件。
