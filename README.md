...
- **`references/pages/`** — **all 5698 pages** from the official HarmonyOS application-dev guide (synced 2026-08-19), fetched from `developer.huawei.com`'s docs API, cleaned, and stored per-slug. Code blocks preserved. Plus 3 hand-distilled Xiaoyi agent pages (`service-agent-*.md`).
