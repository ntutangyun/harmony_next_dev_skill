...
- **`references/pages/`** — **all 5697 pages** from the official HarmonyOS application-dev guide (synced 2026-08-12), fetched from `developer.huawei.com`'s docs API, cleaned, and stored per-slug. Code blocks preserved. Plus 3 hand-distilled Xiaoyi agent pages (`service-agent-*.md`).
...
python scripts/update_docs.py          # fetch all ~5,700 pages (~10 min), swap into references/pages/, rebuild manifest
